...
To calculate this mean value,  we must know the value $$S_i$$ for each day which is 
equal to the total of steps per day and then sum all Si: $$\Sigma S_i$$... then divide by 
the number of days. 
